...
```{r}
setPop(microbov) <- ~Breed/Species #changes the population of the genind object 
bov_dapc <- dapc(microbov, n.pca = 100, n.da = 4) #runs the dapc with 100 principal components; 4 discriminant functions.
